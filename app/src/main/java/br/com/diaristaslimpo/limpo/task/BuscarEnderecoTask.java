 ...
 */
public class BuscarEnderecoTask extends AsyncTask<String, Void, JSONObject> {
    private Context context;
    private ProgressDialog dialog;
    public AsyncJsonObjectResponse delegate = null;

    public BuscarEnderecoTask(Context context) {
    ...
    protected JSONObject doInBackground(String... params) {
        ...
        String url = context.getResources().getString(R.string.url_prefix)
                + context.getResources().getString(R.string.url_buscar_endereco);
