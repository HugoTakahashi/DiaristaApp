 ...
 */
public class RecusarSolicitacaoTask extends AsyncTask<String, Void, String> {
    private Context context;
    private ProgressDialog dialog;
    private String idDiarista;

    public RecusarSolicitacaoTask(Context context) {
    ...
    protected String doInBackground(String... params) {
        ...
        String url = context.getResources().getString(R.string.url_prefix) +
                context.getResources().getString(R.string.url_solicitacao_recusar);
    ...
    protected void onPostExecute(String response) {
        ...
        Toast.makeText(context,
                context.getResources().getString(R.string.mensagem_recusar_solicitacao),
                Toast.LENGTH_LONG)
                .show();
    }
}